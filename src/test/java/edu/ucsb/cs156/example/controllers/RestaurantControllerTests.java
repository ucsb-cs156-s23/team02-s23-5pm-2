...
public class RestaurantControllerTests extends ControllerTestCase {
        ...
        // Authorization tests for /api/restaurants/put

        @Test
        public void logged_out_users_cannot_put() throws Exception {
                mockMvc.perform(put("/api/restaurants/put"))
                                .andExpect(status().is(403));
        }
        ...
        // Authorization tests for /api/restaurants/delete

        @Test
        public void logged_out_users_cannot_delete() throws Exception {
                mockMvc.perform(delete("/api/restaurants/delete"))
                                .andExpect(status().is(403));
        }
